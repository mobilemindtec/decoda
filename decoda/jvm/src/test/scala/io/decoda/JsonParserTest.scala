...
class JsonParserTest extends AnyFunSuite:
  ...
  test("large array of complex objects") {
    val json =
      """[{"name": "John", "age": 30}, {"name": "Alice", "age": 28}, {"name": "Bob", "age": 35}, {"name": "Emma", "age": 32}, {"name": "Michael", "age": 40}]"""
  ...
  test("object with deeply nested structure") {
    val json =
      """{"name": "Alice", "details": {"personal": {"dob": "1990-05-15", "gender": "female"}, "address": {"city": "New York", "zipcode": 10001}, "education": [{"degree": "Bachelor", "university": "ABC University", "year": 2012}, {"degree": "Master", "university": "XYZ University", "year": 2015}]}}"""
  ...
  test("object with deeply nested arrays") {
    val json =
      """{"name": "Bob", "contacts": [{"type": "email", "details": [{"email": "bob@example.com", "verified": true}, {"email": "bob2@example.com", "verified": false}]}, {"type": "phone", "details": [{"phone": "123-456-7890", "verified": true}, {"phone": "987-654-3210", "verified": true}]}]}"""
